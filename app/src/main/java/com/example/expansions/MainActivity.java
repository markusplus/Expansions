...
public class MainActivity extends AppCompatActivity {
    ...
    public static FloatingActionButton next_fav, poblado_fav, carretera_fav, ciudad_fav, carta_fav, consola_fav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carta_fav = findViewById(R.id.carta_fav);
        carta_fav.setEnabled(false);
        ...
        iniciaHexagonos(f, verticalLayout);
    }
